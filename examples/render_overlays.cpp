...
public:
    ...
    void update_green_channel()
    {
        ...
        buffer_accessor->write(*back_buffer, pixel_buffer.pixels(), pixel_buffer.pixel_size());
...
void render_loop(mir::Server& server)
{
    ...
    auto buffer_accessor = platform->make_buffer_accessor();
    ...
    auto client1 = std::make_shared<DemoOverlayClient>(
        *buffer_allocator, buffer_accessor, buffer_properties,0xFF0000FF);
    auto client2 = std::make_shared<DemoOverlayClient>(
        *buffer_allocator, buffer_accessor, buffer_properties,0xFFFFFF00);
