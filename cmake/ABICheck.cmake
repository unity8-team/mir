...
function(make_lib_descriptor name)
  ...
  if ("${name}" STREQUAL "common")
    set(LIB_DESC_HEADERS "${CMAKE_SOURCE_DIR}/include/shared")
  else()
...
set(android-platform-headers "${CMAKE_SOURCE_DIR}/include/shared/mir/graphics/android")

make_lib_descriptor(client)
make_lib_descriptor(server)
make_lib_descriptor(common EXCLUDE_HEADERS ${android-platform-headers})
make_lib_descriptor(platform)
