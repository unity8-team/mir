...
public:
    ...
    void composite()
    {
        ...
        while (compositing)
        {
            ...
            composite_cv.wait(lock, [&]{ return (frames_scheduled > 0) || !compositing; });
    ...
    try
    {
        ...
        std::cout << "Starting compositor thread...." << std::endl;
        ...
        {
            {
                ...
                running_cv.wait(lock, [&]{ return compositing || !running; });
            }
...
private:
    ...
    std::condition_variable composite_cv;
