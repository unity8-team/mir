...
mi::DefaultInputDeviceHub::DefaultInputDeviceHub(
    ...
    std::shared_ptr<mir::CookieFactory> const& c_factory)
...
mi::DefaultInputDeviceHub::RegisteredDevice::RegisteredDevice(
    ...
    std::shared_ptr<mir::CookieFactory> const& cookie_factory,
    DefaultInputDeviceHub* hub)
    : device_id(create_new_device_id()), builder(device_id, cookie_factory), device(dev), dispatcher(dispatcher),
