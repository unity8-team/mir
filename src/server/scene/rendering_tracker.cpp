...
void ms::RenderingTracker::rendered_in(void const* cid)
{
...
void ms::RenderingTracker::occluded_in(void const* cid)
{
    std::lock_guard<std::mutex> lock{guard};
...
void ms::RenderingTracker::active_compositors(std::set<void const*> const& cids)
{
    std::lock_guard<std::mutex> lock{guard};
