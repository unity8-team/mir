...
mga::AndroidBufferHandleDefault::AndroidBufferHandleDefault(ANativeWindowBuffer buf, geom::PixelFormat pf, mc::BufferUsage use)
    : anw_buffer(buf),
      pixel_format(pf),
      buffer_usage(use)
{
...
mc::BufferUsage mga::AndroidBufferHandleDefault::usage() const
{
    return buffer_usage;
}
