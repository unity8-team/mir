...
void ua_ui_set_clipboard_content(void* /*content*/, size_t /*content_size*/)
{
    ...
    printf("ERROR: ua_ui_set_clipboard_content() is not implemented!\n");
}

void ua_ui_get_clipboard_content(void** out_content, size_t* out_content_size)
{
    // TODO<papi>: Fix API and implement it
    printf("ERROR: ua_ui_get_clipboard_content() is not implemented!\n");
    *out_content = nullptr;
    *out_content_size = 0;
}
...
void ua_ui_window_request_state(UAUiWindow *u_window, UApplicationUiWindowState state)
{
    auto window = uamc::Window::from_u_window(u_window);
