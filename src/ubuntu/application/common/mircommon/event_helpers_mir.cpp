...
uaum::event_to_ubuntu_event(MirEvent const* mir_event, Event& ubuntu_ev)
{
    ...
    case mir_event_type_key:
        ...
        ubuntu_ev.details.key.device_id = mir_event->key.device_id;
        ubuntu_ev.details.key.source_id = mir_event->key.source_id;
        ubuntu_ev.details.key.action = mir_event->key.action;
        ubuntu_ev.details.key.flags = mir_event->key.flags;
        ubuntu_ev.details.key.meta_state = mir_event->key.modifiers;
    ...
    case mir_event_type_motion:
        ...
        ubuntu_ev.details.motion.device_id = mir_event->motion.device_id;
        ubuntu_ev.details.motion.source_id = mir_event->motion.source_id;
        ubuntu_ev.details.motion.action = mir_event->motion.action;
        ubuntu_ev.details.motion.flags = mir_event->motion.flags;
        ubuntu_ev.details.motion.meta_state = mir_event->motion.modifiers;
    ...
    case mir_event_type_resize:
        ubuntu_ev.type = RESIZE_EVENT_TYPE;
