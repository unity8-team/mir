...
TEST_F(AndroidInternalClient, internal_client_creation_and_use)
{
    ...
    auto surface_allocator = std::make_shared<ms::SurfaceAllocator>(buffer_stream_factory, stub_input_factory, stub_input_sender, surface_configurator, scene_report);
