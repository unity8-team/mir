...
{
    add_to_environment("MIR_SERVER_PLATFORM_GRAPHICS_LIB", mtf::server_platform_stub_path().c_str());
    add_to_environment("MIR_CLIENT_PLATFORM_LIB", mtf::client_platform_stub_path().c_str());
}
