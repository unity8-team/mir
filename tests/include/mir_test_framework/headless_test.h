 ...
 *  It automatically sets "MIR_SERVER_PLATFORM_GRAPHICS_LIB" to the detected location
 *  of the stub graphics platform as the tests do not hit the graphics hardware.
 */
