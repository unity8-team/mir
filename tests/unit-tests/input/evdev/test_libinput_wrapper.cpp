...
namespace
{
struct StubEventSink : public mir::input::EventSink
{
...
struct LibInputWrapper : public ::testing::Test
{
    ...
    ::testing::NiceMock<mtd::MockInputEventHandlerRegister> mock_register;
...
TEST_F(LibInputWrapper, registers_libinput_fd_on_first_started_device)
{
    ...
    dev1.start(mock_register, stub_sink);
    dev2.start(mock_register, stub_sink);
    dev1.start(mock_register, stub_sink);
}
...
TEST_F(LibInputWrapper, unrregisters_libinput_fd_on_last_active_device)
{
    ...
    dev1.stop(mock_register);
    dev2.stop(mock_register);
    dev1.stop(mock_register);
}
...
TEST_F(LibInputWrapper, receives_and_destroys_events)
{
    ...
    dev.start(mock_register, stub_sink);
