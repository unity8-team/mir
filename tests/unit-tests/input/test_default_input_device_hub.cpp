...
TEST_F(InputDeviceHubTest, input_sink_posts_events_to_input_dispatcher)
{
    ...
    auto event = mir::events::make_event(unset_input_device_id, arbitrary_timestamp, 0, mir_keyboard_action_down, 0, KEY_A, mir_input_event_modifier_none);
...
{
    using namespace ::testing;
    auto touch_event_1 = mir::events::make_event(0, arbitrary_timestamp, 0, mir_input_event_modifier_none);
    mir::events::add_touch(*touch_event_1, 0, mir_touch_action_down, mir_touch_tooltype_finger,
                           21.0f, 34.0f, 50.0f, 15.0f, 5.0f, 4.0f);

    auto touch_event_2 = mir::events::make_event(0, arbitrary_timestamp, 0, mir_input_event_modifier_none);
    ...
    auto touch_event_3 = mir::events::make_event(0, arbitrary_timestamp, 0, mir_input_event_modifier_none);
    ...
    auto touch_event_4 = mir::events::make_event(0, arbitrary_timestamp, 0, mir_input_event_modifier_none);
...
TEST_F(InputDeviceHubTest, forwards_pointer_updates_to_cursor_listener)
{
    ...
    auto event = mir::events::make_event(0, 0ns, 0, mir_input_event_modifier_none, mir_pointer_action_motion, 0,
        x, y, 0.0f, 0.0f);
