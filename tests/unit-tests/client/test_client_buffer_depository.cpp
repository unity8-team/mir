...
TEST_F(MirBufferDepositoryTest, DepositorySetsWidthAndHeight)
{
    using namespace testing;
...
TEST_F(MirBufferDepositoryTest, DepositoryNewDepositChangesCurrentBuffer)
{
    using namespace testing;
...
TEST_F(MirBufferDepositoryTest, DepositorySetsBufferAgeToZeroForNewBuffer)
{
    using namespace testing;
...
TEST_F(MirBufferDepositoryTest, JustSumbittedBufferHasAge_1)
{
    using namespace testing;
...
TEST_F(MirBufferDepositoryTest, SubmittingBufferAgesOtherBuffers)
{
    using namespace testing;
...
TEST_F(MirBufferDepositoryTest, DoubleBufferingReachesSteadyStateAge)
{
    using namespace testing;
...
TEST_F(MirBufferDepositoryTest, TripleBufferingReachesSteadyStateAge)
{
    using namespace testing;
...
TEST_F(MirBufferDepositoryTest, DepositoryDestroysOldBuffers)
{
    using namespace testing;
...
TEST_F(MirBufferDepositoryTest, DepositingPackagesImplicitlySubmitsCurrentBuffer)
{
    using namespace testing;
    const int num_buffers = 3;
...
TEST_F(MirBufferDepositoryTest, DepositoryFreesBuffersAfterReachingCapacity)
{
    using namespace testing;
...
TEST_F(MirBufferDepositoryTest, DepositoryCachesRecentlySeenBuffer)
{
    using namespace testing;
...
TEST_F(MirBufferDepositoryTest, DepositoryCreatesNewBufferForDifferentId)
{
    using namespace testing;
...
TEST_F(MirBufferDepositoryTest, DepositoryKeepsLast_2BuffersRegardlessOfAge)
{
    using namespace testing;
...
TEST_F(MirBufferDepositoryTest, DepositoryKeepsLast_3BuffersRegardlessOfAge)
{
    using namespace testing;
