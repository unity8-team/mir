...
TEST_F(AndroidDisplayTest, test_dpms_configuration_changes_reach_device)
{
    ...
    configuration->for_each_output([&](mg::DisplayConfigurationOutput const& output)
    {
        configuration->configure_output(
            output.id, output.used, output.top_left, output.current_mode_index, output.current_format_index, mir_power_mode_on);
    });
    ...
    {
        configuration->configure_output(
            output.id, output.used, output.top_left, output.current_mode_index, output.current_format_index, mir_power_mode_standby);
    });
    display.configure(*configuration);
    ...
    {
        configuration->configure_output(
            output.id, output.used, output.top_left, output.current_mode_index, output.current_format_index, mir_power_mode_off);
    });
    display.configure(*configuration);
    ...
    {
        configuration->configure_output(
            output.id, output.used, output.top_left, output.current_mode_index, output.current_format_index, mir_power_mode_suspend);
    });
    display.configure(*configuration);
}
