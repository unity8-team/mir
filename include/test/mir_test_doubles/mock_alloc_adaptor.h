...
public:
    ...
    MOCK_CONST_METHOD0(usage,  compositor::BufferUsage());
...
public:
    ...
    MOCK_METHOD3(alloc_buffer, std::shared_ptr<graphics::android::AndroidBufferHandle>(geometry::Size, geometry::PixelFormat, compositor::BufferUsage));
