...
{
    MOCK_METHOD2(associate_surface, frontend::SurfaceId(std::weak_ptr<surfaces::Surface> const&,
                                                        std::shared_ptr<frontend::Surface> const&));
    MOCK_METHOD1(disassociate_surface, void(frontend::SurfaceId surface));
